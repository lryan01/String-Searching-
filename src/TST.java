...
/**
 * The <tt>TST</tt> class represents an symbol table of key-value pairs, with
 ...
 * a given prefix, finding all strings in the symbol table that
 * <em>start with</em> a given prefix, and finding all strings in the symbol
 * table that <em>match</em> a given pattern. A symbol table implements the
 ...
 * convention that values cannot be <tt>null</tt>&mdash;setting the value
 * associated with a key to <tt>null</tt> is equivalent to deleting the key from
 * the symbol table.
 * <p>
